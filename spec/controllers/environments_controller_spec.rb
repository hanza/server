...
describe EnvironmentsController do
  ...
  describe "GET new" do
    it "assigns a new environment as @environment" do
      ...
      assigns(:environment).should be_a_new(Environment)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created environment as @environment" do
        post :create, {:environment => valid_attributes}, valid_session
        assigns(:environment).should be_a(Environment)
        assigns(:environment).should be_persisted
      end

      it "redirects to the created environment" do
        post :create, {:environment => valid_attributes}, valid_session
        response.should redirect_to(Environment.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved environment as @environment" do
        ...
        Environment.any_instance.stub(:save).and_return(false)
        post :create, {:environment => {  }}, valid_session
        assigns(:environment).should be_a_new(Environment)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested environment" do
        environment = Environment.create! valid_attributes
        # Assuming there are no other environments in the database, this
        # specifies that the Environment created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Environment.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => environment.to_param, :environment => { "these" => "params" }}, valid_session
      end
      ...
      it "redirects to the environment" do
        environment = Environment.create! valid_attributes
        put :update, {:id => environment.to_param, :environment => valid_attributes}, valid_session
        response.should redirect_to(environment)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the environment as @environment" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Environment.any_instance.stub(:save).and_return(false)
        put :update, {:id => environment.to_param, :environment => {  }}, valid_session
        assigns(:environment).should eq(environment)
      end
